          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <CardContent className="p-0">
                <div className="bg-gray-100 rounded-lg p-8 mb-4">
                  <div className="w-full h-48 bg-gray-200 rounded flex items-center justify-center">
                    <div className="text-gray-500">Vertical Striped Shirt</div>
                  </div>
                </div>
                <h4 className="font-semibold mb-2">Vertical Striped Shirt</h4>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-500 line-through">$232</span>
            ...
            <Card className="border-0 shadow-none">
              <CardContent className="p-0">
                <div className="bg-gray-100 rounded-lg p-8 mb-4">
                  <div className="w-full h-48 bg-gray-200 rounded flex items-center justify-center">
                    <div className="text-gray-500">Courage Graphic T-shirt</div>
                  </div>
                </div>
                <h4 className="font-semibold mb-2">Courage Graphic T-shirt</h4>
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex text-yellow-400">
                    {[...Array(4)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current" />
            ...
            <Card className="border-0 shadow-none">
              <CardContent className="p-0">
                <div className="bg-gray-100 rounded-lg p-8 mb-4">
                  <div className="w-full h-48 bg-gray-200 rounded flex items-center justify-center">
                    <div className="text-gray-500">Loose Fit Bermuda Shorts</div>
                  </div>
                </div>
                <h4 className="font-semibold mb-2">Loose Fit Bermuda Shorts</h4>
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex text-yellow-400">
                    {[...Array(3)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current" />
                  ...
                  <span className="text-sm text-gray-600">3.0/5</span>
                </div>
            ...
            <Card className="border-0 shadow-none">
              <CardContent className="p-0">
                <div className="bg-gray-100 rounded-lg p-8 mb-4">
                  <div className="w-full h-48 bg-gray-200 rounded flex items-center justify-center">
                    <div className="text-gray-500">Faded Skinny Jeans</div>
                  </div>
                </div>
                <h4 className="font-semibold mb-2">Faded Skinny Jeans</h4>
                <div className="flex items-center gap-2 mb-2">
                  <div className="flex text-yellow-400">
                    {[...Array(4)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current" />
