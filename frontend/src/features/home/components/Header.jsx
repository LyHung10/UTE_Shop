                      ...
                      {({ active }) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 text-sm transition-colors ${
                            active ? "bg-blue-500/20 text-blue-300" : "text-white"
                          }`}
                        >
                          Tài khoản của tôi
                        </button>
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-3 text-sm transition-colors border-t border-blue-500/20 ${
                            active ? "bg-red-500/20 text-red-300" : "text-white"
                          }`}
                        >
                          Đăng xuất
                        </button>
