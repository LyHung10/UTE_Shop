import { Mail, Phone, MapPin, Facebook, Instagram, Twitter, Linkedin, Youtube, Send, Heart, Sparkles, ShoppingBag } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"

export default function ModernFooter() {
  return (
    <footer className="relative bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50">
      {/* Decorative top wave */}
      ...
      {/* Newsletter Section */}
      <div className="relative pt-20 pb-8 border-b border-blue-200">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
              {/* Decorative elements */}
              ...
              <div className="relative z-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto">
                  <Input 
                    ...
                    className="flex-1 bg-white border-0 text-gray-800 placeholder:text-gray-500 h-14 text-lg rounded-2xl shadow-lg focus:ring-2 focus:ring-white/50"
                  />
                  <Button className="bg-gray-900 hover:bg-gray-800 text-white px-8 h-14 rounded-2xl shadow-lg font-semibold transition-all hover:scale-105">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h2 className="text-4xl font-black bg-gradient-to-r from-blue-600 via-cyan-600 to-teal-600 bg-clip-text text-transparent">
                  UTE SHOP
                </h2>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  { Icon: Instagram, gradient: "from-pink-500 via-purple-500 to-blue-500" },
                  { Icon: Twitter, gradient: "from-sky-400 to-blue-500" },
                  { Icon: Youtube, gradient: "from-red-500 to-red-600" },
                  { Icon: Linkedin, gradient: "from-blue-600 to-cyan-600" }
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["About Us", "Our Story", "Careers", "Press & Media", "Sustainability"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors duration-300 flex items-center gap-2 group text-base">
                    <span className="w-0 group-hover:w-2 h-2 rounded-full bg-blue-500 transition-all duration-300"></span>
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Customer Support", "Track Order", "Shipping Info", "Returns Policy", "Size Guide"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-600 hover:text-cyan-600 transition-colors duration-300 flex items-center gap-2 group text-base">
                    <span className="w-0 group-hover:w-2 h-2 rounded-full bg-cyan-500 transition-all duration-300"></span>
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Terms of Service", "Privacy Policy", "Cookie Settings", "Accessibility", "Sitemap"].map((item) => (
                <li key={item}>
                  <a href="#" className="text-gray-600 hover:text-teal-600 transition-colors duration-300 flex items-center gap-2 group text-base">
                    <span className="w-0 group-hover:w-2 h-2 rounded-full bg-teal-500 transition-all duration-300"></span>
                    {item}
                  </a>
                </li>
              ))}
      ...
      {/* Bottom Bar */}
      <div className="border-t border-blue-200 bg-gradient-to-r from-white/60 to-blue-50/60 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-gray-600 flex items-center gap-2 flex-wrap justify-center">
              <span>© 2025</span>
              <span className="text-gray-900 font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">UTE SHOP</span> 
            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
              ...
              <div className="flex gap-2">
                {[
                  ...
                  { name: "MC", color: "from-blue-500 to-cyan-600" },
                  { name: "PP", color: "from-cyan-500 to-blue-500" },
                  { name: "AMEX", color: "from-blue-700 to-indigo-700" },
                  { name: "GPay", color: "from-teal-600 to-cyan-600" }
                ].map((method) => (
                  <div
                    key={method.name}
